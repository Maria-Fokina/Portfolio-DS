...
|:---------------------- |:-----------------|:---------------------- | :---------------------- |
| [Стандартизация названий спортивных школ (решение в процессе)](sport_school) |NLP |Цель проекта: сформировать и обучить модель, которая сможет эффективно определять эталонное наименование школы по вводу наименований с ошибками| *Pandas, Python, NumPy, sentence_transformers* |
